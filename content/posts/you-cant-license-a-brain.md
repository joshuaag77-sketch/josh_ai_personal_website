---
title: "You Can't License a Brain"
date: "2026-07-15"
tags: ["ai", "career", "second-brain", "ownership"]
summary: "A friend pitched me the trillion-dollar idea — rent your brain to companies like it's YouTube for your mind. I don't think it works, and why it doesn't is the useful part."
kicker: "Field Notes"
heroImage: "/images/thumb-license-brain.svg"
heroAlt: "A solid knowledge-graph node beside a faded, dashed copy that fails to duplicate."
heroCaption: "You can copy the file. You can't copy the track record."
status: "published"
featured: false
---

A few days before I left my job to start business school, I got on a call with a guy I'd hired a couple years ago to help me study for a test. It was meant to be a quick catch-up. Two hours later we were still going, because it turned out we'd both quietly gotten obsessed with the same thing — building a "second brain," a personal vault of notes and transcripts an AI can read and reason over.

Somewhere in the second hour he pitched me the big one. Half joking, he called it the trillion-dollar idea. What if you didn't just *build* your second brain — what if you *rented* it? You generate a ton of valuable insight at work, and right now your employer gets all of it for free. Imagine instead that your brain is a service other people pay to query. A personal server that licenses your judgment by the use. YouTube, but for your mind — you keep the IP, the platform just takes a cut. A digital twin that keeps earning after you've retired. After you've died.

It's a good pitch. I don't think it works. And the reason it doesn't turned out to be more useful than the pitch.

First, what he got right, because it's most of it. As AI floods the world with cheap, passable content, the genuinely real thing gets *more* valuable, not less. Scarcity moves. You should own your context and be able to swap the model underneath it like a battery. The person who owns their data has leverage the person renting a chatbot doesn't. All true. The direction — toward ownership — is right. It's the mechanism that breaks.

## Two tests

For something to be a rentable asset, it has to pass two tests. Your brain fails both.
...
Here's the turn, and it's why the call was worth two hours. The instinct to own something is right. It's just aimed at the wrong target. Three things pass both tests:
...
*Written as I think it through, not from any settled view — I changed my mind about half of this mid-conversation. If you're building a second brain too, I'd like to compare notes.*
